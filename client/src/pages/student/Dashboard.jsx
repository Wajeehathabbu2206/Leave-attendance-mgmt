...
export default function Dashboard() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      api.get("/student/attendance/alerts"),
    ])
      .then(
        ([
          attendanceResponse,
  ...
  return (
    <PageLayout>
      <div className="mb-6 flex items-end justify-between gap-4">
        <div>
          <p className="overview-kicker">Student overview</p>
          <h1 className="overview-title">Your school day, clearly organized</h1>
        </div>
        <p className="hidden text-xs text-[#5B7590] sm:block">
      ...
      {!attendance && !error ? (
        ...
        <>
          ...
          <AttendanceOverviewCard
            ...
            detailsPath="/student/attendance"
            summary={counts}
